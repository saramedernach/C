...
public:
  static NoodleShop* create(
    unsigned int        npots,      // The number of pots you have available.
    unsigned int        rent,       // The amount you paid to rent a stall for the day.
    unsigned int        customers,  // The approximate number of customers you expect today.
...
public:
  ...
  virtual std::vector<Order> orders(unsigned int minute, std::vector<Order> orderlist) = 0;
